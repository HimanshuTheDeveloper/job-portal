...
<body>
          ...
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            <div class="card card-primary">
              <div class="card-header">
                <h4>Register as a Job Provider</h4>
              </div>
              <div class="card-body">
                <form method="POST" id="provider-register">
                  <div class="row">
              ...
              <div class="mb-4 text-muted text-center">
                Already Registered? <a href="{{route('job_provider.login')}}">Login</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    $(function () {
        $('#provider-register').on('submit', function(e){
            e.preventDefault()
            ...
            $.ajax({
                url: "{{ route('job_provider.providerRegistered') }}",
                type:"POST",
                data: fd,
                dataType: 'json',
                processData: false,
