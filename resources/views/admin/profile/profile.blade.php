            ...
            <div class="card-body">
              <div class="author-box-center">
                ...
                <div class="author-box-name">
                  <a href="#">{{ucfirst($adminData->name)}}</a>
                </div>
                ...
                <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab2">
                  <div class="row">
                    <div class="col-md-3 col-6 b-r">
                      ...
                      <br>
                      <p class="text-muted">{{ucfirst($adminData->name)}}</p>
                    </div>
                    <div class="col-md-3 col-6 b-r">
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="form-group col-md-6 col-12">
                          ...
                          <input type="date" class="form-control" value="{{$adminData->dob}}">
                          <div class="invalid-feedback">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-5 col-12">
                          <label>Phone</label>
                          <input type="tel" class="form-control" value="9087654321">
                        </div>
                      </div>
                      <div class="row">
                        <div class="form-group col-12">
                          <label>Bio</label>
                          <textarea
                            class="form-control summernote-simple">{{$adminData->bio}}</textarea>
                        </div>
                      </div>
                      <div class="row">
